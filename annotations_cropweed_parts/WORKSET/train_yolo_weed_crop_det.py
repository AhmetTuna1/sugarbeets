"""
YOLOv8s Multi-Class Object Detection Eğitim Scripti (Colab-Ready)
=================================================================
...
Sınıflar:
0: weed  (Yabancı Ot - Maske Değeri: 10000)
1: crop  (Şeker Pancarı - Maske Değeri: 1-9999 arası)
"""
...
def mask_to_multiclass_bboxes(mask_path):
    """
    16-bit maskelerden hem ot hem de pancar bounding box'larını çıkarır.
    """
    try:
...
def train_multiclass_detection():
    ...
    # 3. Eğitim
    print(f"\n[ADIM 3/3] YOLOv8s Multi-Class eğitimi başlatılıyor...\n")
    
    # AUTO-RESUME
    last_pt_path = os.path.join(RESULTS_DIR, "sugarbeet_multiclass_s", "weights", "last.pt")
    ...
    print(f"  Sonuçlar: {RESULTS_DIR}/sugarbeet_multiclass_s/")
    print("=" * 60)
